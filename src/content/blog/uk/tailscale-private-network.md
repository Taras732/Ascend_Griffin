...
1. **Відкриваємо порти роутера у відкритий інтернет** замість Tailscale. Це працює, але це **дірка в нашій безпеці**: будь-хто з інтернету може спробувати влізти. Tailscale — те ж саме (доступ до коробки звідки завгодно), але без дірки
