...
If we want to re-read the series from the beginning — [Post 1: Building a Personal Knowledge Base on Obsidian + AI](/blog/obsidian-ai-knowledge-base/).

If we want to follow what comes next (the upcoming topics are different — not Obsidian) — [LinkedIn here](https://www.linkedin.com/in/taras732/).
