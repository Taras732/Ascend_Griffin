...
- **We have three versions of the same file** — `_final`, `_final2`, `_final_v3_FINAL`. And we have no idea which one is the fresh one.
...
1. Let's open [obsidian.md](https://obsidian.md) in the browser, click the big **Download** button, run the downloaded file.
